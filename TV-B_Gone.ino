...
void sendAllCodes() {
  ...
  // ===== HISENSE (official discrete codes from Hisense USA) =====
  pr("Hisense POWER OFF");
  IrSender.sendNEC(0x20, 0x4E, 2);
  delay(100);

  pr("Hisense POWER TOGGLE");
  IrSender.sendNEC(0x20, 0x0E, 2);
  delay(100);

  pr("Hisense POWER ON");
  IrSender.sendNEC(0x20, 0x8E, 2);
  delay(100);

  pr("Hisense alt family");
  IrSender.sendNEC(0x00, 0x10, 2);
  delay(100);
